...
(select distinct person_id,obs_datetime from obs where obs_datetime between cast('#startDate#' as date) and cast('#endDate#'  as date) and concept_id=4844 and voided=0) as b 
